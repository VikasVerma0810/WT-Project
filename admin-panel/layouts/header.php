      ...
      <div class="collapse navbar-collapse" id="navbarText">
        <?php if(isset($_SESSION['adminname'])) : ?>
          <ul class="navbar-nav side-nav" >
            ...
            <li class="nav-item">
              <a class="nav-link" href="<?php echo ADMINURL; ?>/announcements/show-announce.php" style="margin-left: 20px;">Announcements</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="<?php echo ADMINURL; ?>/timeline/show-timeline.php" style="margin-left: 20px;">Timeline</a>
            </li>

            <li class="nav-item">
              <a class="nav-link" href="<?php echo ADMINURL; ?>/gallery/show-gallery.php" style="margin-left: 20px;">Gallery</a>
            </li>
